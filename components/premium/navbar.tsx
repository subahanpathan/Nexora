...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="absolute inset-0 -z-10 border-b border-white/[0.08] bg-[#07070b]/70 backdrop-blur-2xl" />
      <div className="mx-auto flex h-16 max-w-[1600px] items-center gap-3 px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  {active && (
                    <motion.div
                      layoutId="navActive"
                      className="absolute inset-0 z-0 rounded-full border border-white/[0.09] bg-white/[0.06]"
                    />
                  )}
        ...
        <div className="ml-auto hidden max-w-md flex-1 md:block">
          ...
          >
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 opacity-0 blur-xl transition-opacity group-focus-within:opacity-100" />
            <div
              onClick={() => setIsAIOpen(true)}
              className="relative flex cursor-text items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.02] px-4 py-2.5 transition-all group-hover:border-white/20 group-focus-within:border-violet-500/40"
            >
              ...
              <div className="w-full bg-transparent text-sm text-white/40 outline-none">
                Search Nexora or ask AI...
              </div>
              <kbd className="hidden rounded-lg border border-white/10 bg-white/[0.05] px-2 py-0.5 text-[10px] font-bold text-white/30 sm:inline">
                ⌘K
              </kbd>
            </div>
          </motion.div>
        ...
        <div className="ml-auto flex items-center gap-2 md:ml-0">
          <Link
            href="/create"
            className="hidden items-center gap-1.5 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 px-4 py-2 text-sm font-medium text-white shadow-[0_8px_30px_-8px_rgba(139,92,246,0.7)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_40px_-4px_rgba(139,92,246,0.9)] active:scale-95 sm:inline-flex"
          >
          ...
          <button className="ml-1 hidden items-center gap-2 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-1.5 pr-3 transition-all hover:border-white/20 hover:bg-white/[0.05] md:flex">
            <div className="h-7 w-7 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center font-bold text-[10px] text-white">
               N
            </div>
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-xl border border-white/[0.08] bg-white/[0.03] text-white lg:hidden"
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -8 }}
            className="mx-4 mb-4 rounded-2xl border border-white/[0.08] bg-[#0b0b11]/90 p-3 backdrop-blur-2xl lg:hidden"
          >
